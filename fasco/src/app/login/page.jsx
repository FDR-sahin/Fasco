    ...
    <section className="max-w-350 mx-auto p-10 mt-25">
      <div className="border-2 border-[#DBDBDB] grid md:grid-cols-2 grid-cols-1 gap-2">
        ...
        <div className="p-10">
          ...
          <div className="mr-3">
            <h3 className="text-[30px] text-[#000000] pt-7">
              Sign In To FASCO
            </h3>
            ...
            <div className="py-10 text-center text-[30px] text-[#838383]">
              -OR-
            </div>
            ...
            <div className="px-4">
              ...
              <p className="pt-4 text-end text-[#000000]">
                <Link className="text-[#5B86E5]" href="/forget-password">
                  Forget Password?
                </Link>
              </p>
            </div>
          </div>
          <p className="text-end mt-15">FASCO Terms & Codnitions</p>
        </div>
      </div>
    </section>
  );
